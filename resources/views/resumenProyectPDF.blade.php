            ...
            <div class="col-md-12">
                <table class="table table-striped table-sm" style="font-size:10px;text-align: justify">
                    ...
                    {{-- <tr>
                       ...
                       <tr class="col-md-12">
                         <td colspan="2">
                            <strong>Descripción del Proyecto (3 preguntas)</strong>
                         </td>
                       </tr>
                    <tr>
                        <td><strong>¿Quiénes son ustedes como organización o grupo?</strong></td>
                        <td>{{ $proyecto->descripProyectoPreg1 }}</td>
                    </tr>
                     <tr>
                        <td><strong>¿Qué les gustaría lograr con este proyecto?</strong></td>
                        <td>{{ $proyecto->descripProyectoPreg2 }}</td>
                    </tr>
                       <tr>
                        <td><strong>¿Qué problemas importantes tienen hoy en día y cómo este fondo podría ayudar a solucionarlos?</strong></td>
                        <td>{{ $proyecto->descripProyectoPreg3 }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><strong>¿Que problema o necesidad busca resolver?</strong></td>
                    ...
                    <tr>
                        <td><strong>¿A qué territorio apoyará el proyecto?</strong></td>
                        <td>{{ $proyTipoTerritorioStr }}</td>
                    </tr>
                    ...
                    <tr>
                        <td><strong>¿Cómo se difundirá el proyecto?</strong></td>
                        <td>{{ $proyTipoDifusionStr }}</td>
                    </tr>
                    ...
                    <tr>
                        <td><strong>¿Cómo comprobarán que se hicieron las actividades del proyecto?</strong></td>
                        <td>{{ $proyTipoMedioVerificacionStr }}</td>
                    </tr>
                </table>
            </div>
            <div class="col-md-12">
