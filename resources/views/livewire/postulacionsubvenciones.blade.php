...
{{-- <div class="card shadow" id="cabecera">
            <div class="card-header text-center h4 py-3">
                Postulaci&oacute;n Iniciativas Fondo de Vinculaci&oacute;n con la Comunidad-Subvenciones 2025
            </div>
<div class="card-body">  --}}
    <form>
        @csrf
                ...
                <div class="col-10 col-md-10 mb-3">
                    <div class="alert alert-info border border-info my-3 mx-3 my-md-4 mx-md-4 text-center" role="alert">
                        ...
                        <span class="fs-6 fst-italic pt-4">
                            ...
                            Calendario de postulaciones 2026 pronto a informar.
                        </span>
                    </div>
                </div>
    ...
    <div class="col-12 text-center">
              <div class="alert alert-info border border-info mb-1 shadow mx-4" role="alert">
                        <p class="fs-5 fst-italic px-4 mt-3" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                ...
                                E</span><span class="fs-6">n la presente página usted podrá postular a todos los fondos que se encuentren abiertos <b>distintos</b> a <b>Asignación Directa</b>. Los cuales 
                                estarán disponibles para postulación desde el <b>lunes 1 de Septiembre</b> hasta el <b>domingo 14 de Septiembre del 2025 inclusive</b>. Para comenzar a postular, 
                                ingrese el RUN de la organización y presione el botón <b>Comenzar Postulación</b>. En el caso de que haya ingresado un proyecto y aún no lo ha enviado para postulación,
                                una vez que ingrese el run se desplegará una tabla donde podrá continuar con la postulación pinchando en el link con el nombre del proyecto.</span><br>                                
                                <br>
                        </p>
                        </div>
        </div>
...
<div class="row ms-0">
    <div class="col-12 text-center">
              <div class="alert alert-info border border-info  shadow me-2" role="alert">                        
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                L</span><span class="fs-6">os datos serán almacenados una vez que presione el boton <b>Siguiente</b>.</span>                                
                        </p>
                        </div>
        </div>
</div>
        ...
        <div class="container pt-3">
            <div class="card" id="datosOrganizacion">
                ...
                <div class="card-body">
                    ...
                    {{-- 28-08-2025 Se agrega tipo de organización --}}
                     <div class="row ms-0 mb-2 ms-md-4 mb-md-3">
                       <div class="col-12 col-md-9">
                            <div class="row pe-0 pt-1 pt-md-0">
                                <div class="col-12" id="idcodTipoInstitucion">
                                    <label>Tipo Institución</label>
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i class="bi bi-signpost-2"></i>
                                        </span>
                                        <select id="codTipoInstitucion" wire:model="codTipoInstitucion" wire:loading.attr="disabled" wire:target="firstStep" class="form-select">
                                            <option value="0">Sel. Tipo Institución</option>
                                            @foreach($tipoInstitucionCmb as $itemTipoInst)
                                            <option value="{{$itemTipoInst->codTipoInstitucion}}">{{$itemTipoInst->descripcionTipoInstitucion}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                @error('codTipoInstitucion')
                                <div class="col-12" id="idcodTipoInstitucionError">
                                    <span class="colorerror">{{ $message }}</span>
                                </div>
                                @enderror
                            </div>
                    ...
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-3"> 
                        <div class="col-12 col-md-4">
                            <div class="row pe-0 pt-2 pt-md-0">
                                <div class="col-12" id="idagnosExistencia">
                                    <label data-tippy-content="En el certificado de vigencia debe calcular los años desde la de fecha de inscripción hasta hoy. Haga click en en el Icono &lt;i class=&quot;bi bi-info-circle fs-5&quot;&gt;&lt;/i&gt; para ver un ejemplo gráfico.">
                                        Años de Existencia Legal</label> <i class="bi bi-info-circle-fill fs-5 ps-2" onclick="showmodalInfoAgnosExist()" data-tippy-content="Click para ver ejemplo"></i>
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i class="bi bi-clock-history"></i>
                                        </span>
                                        <input type="text" id="agnosExistencia" wire:model.debounce.250ms="agnosExistencia" wire:loading.attr="disabled" wire:target="firstStep" onkeydown="return onlyNumberKey(event, this);" maxlength="3" class="form-control" placeholder="Cantidad Años" data-tippy-content="Ingrese cantidad de años de existencia legal de la institución. Click en el icono &lt;i class=&quot;bi bi-info-circle fs-5&quot;&gt;&lt;/i&gt; para ver ejemplo gráfico." autocomplete="off">
                                    </div>                                    
                                </div>                             
                                <div class="col-12">
                                    <span class="text-success" style="font-size:14px;font-style: italic;">(Las entidades públicas no deben completar este campo)</span>
                                </div>
                        ...
                        <div class="row pe-0 pt-3 pe-md-0 pt-md-0">
                                <div class="col-12 col-md-3 pe-0 pe-md-0" id="idcodTipoVia">
                                ...
                                <!-- <div class="col-5" id="iddireccionOrganizacion">
                                 ...
                                 <div class="col-12 col-md-5" id="idnombreVia">
                                    <label>Nombre {{$descripTipoVia}}</label>
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i class="bi bi-signpost-2"></i>
                                ...
                                <div class="col-12 col-md-2" id="idnumDireccion">
                                    <label>Número</label>
                        ...
                        <div class="col-12 mb-2 col-md-6">
                            <div class="row">
                                <div class="col-12 pt-3 col-md-8 pt-md-2" id="idfecVencDirectiva">  
                                    <label data-tippy-content="La fecha de vencimiento la debe calcular en el certificado de directorio sumandole a la fecha de última elección de directiva los años de duración de directiva. Haga click en en el icono &lt;i class=&quot;bi bi-info-circle fs-5&quot;&gt;&lt;/i&gt; para ver un ejemplo gráfico.">
                                        Fecha Vencimiento Directiva Actual
                                    </label> <i class="bi bi-info-circle-fill fs-5 ps-2" onclick="showmodalInfoFecVencDirectiva()" data-tippy-content="Click para ver ejemplo"></i>
        ...
        <div class="container pt-3 px-2 px-md-4">
            <div class="card mb-5" id="datosAdmHead">
                ...
                <div class="card-body py-4 py-md-5">
                    ...
                    <div class="row ms-0 ms-md-4">                       
                        <div class="col-12 mb-3 mb-md-4 col-md-11">
                            <div class="row">
            ...
            <div class="card mt-1 mb-5" id="datosTecnicos">
                ...
                <div class="card-body">
                    ...
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-3">
                        ...
                        <div class="row ms-0 ms-md-1 mt-md-5 me-3">
                        <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mt-1">Descripción del Proyecto (completar las siguientes 3 preguntas)</h5>
                            
                            <h6 class="card-subtitle mb-2 text-body-secondary mt-3" id="iddescripProyectoPreg1">¿Quiénes son ustedes como organización o grupo?</h6>
                            <textarea wire:model="descripProyectoPreg1" wire:loading.attr="disabled" wire:target="secondStep,back" class="form-control" placeholder="¿Quiénes son ustedes como organización o grupo? (máximo 500 caracteres)" maxlength="500" rows="4"></textarea>
                            @error('descripProyectoPreg1')
                                <div class="col-12 pe-md-5" id="iddescripProyectoPreg1Error">
                                    <span class="colorerror">{{ $message }}</span>
                                </div>
                            @enderror
                            
                        <h6 class="card-subtitle mb-2 text-body-secondary mt-3" id="iddescripProyectoPreg1">¿Qué les gustaría lograr con este proyecto? </h6>
                            <textarea wire:model="descripProyectoPreg2" wire:loading.attr="disabled" wire:target="secondStep,back" class="form-control" placeholder="¿Qué les gustaría lograr con este proyecto? (máximo 500 caracteres)" maxlength="500" rows="4"></textarea>
                             @error('descripProyectoPreg2')
                                <div class="col-12 pe-md-5" id="iddescripProyectoPreg2Error">
                                    <span class="colorerror">{{ $message }}</span>
                                </div>
                            @enderror
                            
                        <h6 class="card-subtitle mb-2 text-body-secondary mt-3" id="iddescripProyectoPreg1">¿Qué problemas importantes tienen hoy en día y cómo este fondo podría ayudar a solucionarlos?</h6>
                            <textarea wire:model="descripProyectoPreg3" wire:loading.attr="disabled" wire:target="secondStep,back" class="form-control" placeholder="¿Qué problemas importantes tienen hoy en día y cómo este fondo podría ayudar a solucionarlos? (máximo 500 caracteres)" maxlength="500" rows="4"></textarea>
                            @error('descripProyectoPreg3')
                                <div class="col-12 pe-md-5" id="iddescripProyectoPreg3Error">
                                    <span class="colorerror">{{ $message }}</span>
                                </div>
                            @enderror
                            <div class="mb-2"></div>
                    ...
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-1 mt-md-4">
                        <div class="col-12 col-md-10 h5" id="iddescripNecesidadACubrir"  data-tippy-content="En un texto breve responda las siguientes preguntas: ¿Qué problema tienen hoy?, 
                        ¿Qué les falta o qué no funciona bien?, ¿Qué les gustaría mejorar o conseguir con este proyecto?. Por ejemplo: Nuestra sede tiene el techo con goteras y necesitamos repararlo, 
                        Los niños del barrio no tienen actividades y queremos realizar talleres, Los adultos mayores necesitan un lugar cómodo para reunirse.">
                            {{-- Descripción de la Necesidad a Cubrir o Problemática en el Territorio --}}
                            ¿Que problema o necesidad busca resolver?
                        </div>
                    </div>
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-3">
                        <div class="col-12 pe-md-5">
                            <textarea wire:model="descripNecesidadACubrir" wire:loading.attr="disabled" wire:target="secondStep,back" class="form-control" maxlength="1000" 
                            {{-- placeholder="Describa las necesidades del territorio beneficiario del proyecto, o la problemática del territorio a intervenir, que hace que el proyecto sea necesario (máximo 1000 caracteres)"  --}}
                            placeholder="En un texto breve responda las siguientes preguntas: ¿Qué problema tienen hoy?, ¿Qué les falta o qué no funciona bien?, ¿Qué les gustaría mejorar o conseguir con este proyecto?. Por ejemplo: Nuestra sede tiene el techo con goteras y necesitamos repararlo, Los niños del barrio no tienen actividades y queremos realizar talleres, Los adultos mayores necesitan un lugar cómodo para reunirse. (máximo 1000 caracteres)"
                            rows="6"></textarea>
                        </div>
                    ...
                    <div class="row ms-0 ms-md-1 mt-md-4 me-md-5">
                        <div class="card ms-3 me-md-5">
                        <div class="card-body" id="idcodTipoTerritoriosCheck"> 
                            <h5 class="card-title mt-1 mb-3">¿A qué territorio apoyará el proyecto?</h5>            
                            @if (!empty($tipoTerritorios))
                              @foreach($tipoTerritorios as $index => $itemTipTerritorio)                          
                               
                                    @if($itemTipTerritorio->codTipoTerritorio == 6) {{-- Otro --}}
                                         <div class="form-check form-switch">
                                           <input class="form-check-input" type="checkbox" wire:model="codTipoTerritoriosCheck" role="switch" id="flexSwitchCheckflgConductor" value="{{ $itemTipTerritorio->codTipoTerritorio }}">
                                           <label class="form-check-label campo-glosa" for="flexSwitchCheckflgConductor">{{ $itemTipTerritorio->descripcionTipoTerritorio }}</label>
                                         </div>
                                    
                                         {{-- Si se selecciona se muestra el input descripTipoTerritorioOtro --}}
                                        @if (!empty($tipoTerritorios))
                                            @foreach($codTipoTerritoriosCheck as $index => $itemChk)     
                                             @if($itemChk == 6) {{-- Otro --}}           
                                              <input type="text" id="descripTipoTerritorioOtro" wire:model.debounce.250ms="descripTipoTerritorioOtro" wire:loading.attr="disabled" wire:target="firstStep" maxlength="300" class="form-control mt-2" placeholder="Descripción Otro (opcional)">                                                   
                                             @endif
                                            @endforeach                  
                                        @endif                                           
                                    @else
                        ...
                        @error('codTipoTerritoriosCheck')
                        <div class="col-12 pe-md-5" id="idcodTipoTerritoriosCheckError">
                            <span class="colorerror">{{ $message }}</span>
                        </div>
                        @enderror                            
                            <div class="mb-2"></div>
                    ...
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-3">
                     ...
                     <div class="row ms-0 ms-md-1 mt-md-4 me-md-5">
                        <div class="card ms-3 me-md-5">
                        <div class="card-body" id="idcodTipoDifusionCheck"> 
                            <h5 class="card-title mt-1 mb-3">¿Cómo se difundirá el proyecto? </h5>            
                            @if (!empty($tipoDifusion))
                              @foreach($tipoDifusion as $index => $itemTipDifusion) 
                                    @if($itemTipDifusion->codTipoDifusion == 7) {{-- Otro --}}
                                         <div class="form-check form-switch">
                                           <input class="form-check-input" type="checkbox" wire:model="codTipoDifusionCheck" role="switch" id="flexSwitchCheckTipoDifusions" value="{{ $itemTipDifusion->codTipoDifusion }}">
                                           <label class="form-check-label campo-glosa" for="flexSwitchCheckTipoDifusions">{{ $itemTipDifusion->descripcionTipoDifusion }}</label>
                                         </div>
                                    
                                         {{-- Si se selecciona se muestra el input descripTipoDifusionOtro --}}
                                        @if (!empty($tipoDifusion))
                                            @foreach($codTipoDifusionCheck as $index => $itemChk)     
                                             @if($itemChk == 7) {{-- Otro --}}           
                                              <input type="text" id="descripTipoDifusionOtro" wire:model.debounce.250ms="descripTipoDifusionOtro" wire:loading.attr="disabled" wire:target="firstStep" maxlength="300" class="form-control mt-2" placeholder="Descripción Otro (opcional)">                                                   
                                             @endif
                                            @endforeach                  
                                        @endif                                           
                                    @else
                            ...
                            @error('codTipoDifusionCheck')
                                <div class="col-12 pe-md-5" id="idcodTipoDifusionCheckError">
                                    <span class="colorerror">{{ $message }}</span>
                                </div>
                            @enderror
                            <div class="mb-2"></div>
                    ...
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-1 mt-md-4">
                        <div class="col-12 col-md-10 h5" id="iddescripResultadoProy" data-tippy-content="¿Que espera conseguir y tener al final del proyecto?, ¿Que logros podrá mostrar como prueba de que el proyecto se hizo bien?, ¿Qué cosas concretas se van a tener cuando finalice el proyecto?, ¿Qué beneficios reales recibirán las personas o la comunidad?, ¿Cómo sabremos que el proyecto resultó?">
                            Resultados y/o Productos Esperados
                        </div>
                    </div>
                    <div class="row ms-0 mb-2 ms-md-4 mb-md-3">
                        <div class="col-12 pe-md-5">
                            <textarea wire:model="descripResultadoProy" wire:loading.attr="disabled" wire:target="secondStep,back" class="form-control" maxlength="2000" 
                            placeholder="¿Que espera conseguir y tener al final del proyecto?, ¿Que logros podrá mostrar como prueba de que el proyecto se hizo bien?, ¿Qué cosas concretas se van a tener cuando finalice el proyecto?, ¿Qué beneficios reales recibirán las personas o la comunidad?, ¿Cómo sabremos que el proyecto resultó?, (máximo 2000 caracteres)" rows="6"></textarea>
                        </div>
                    ...
                    <!-- Fin Agregado el 15-02-2023 por MVillalobos -->
                        ...
                        <div class="row ms-0 ms-md-1 mt-md-4 me-md-5">
                        <div class="card ms-3 me-md-5" id="idcodTipoMedioVerificacionCheck">
                        <div class="card-body"> 
                            <h5 class="card-title mt-1 mb-3">¿Cómo comprobarán que se hicieron las actividades del proyecto?</h5>            
                            @if (!empty($tipoMedioVerificacion))
                              @foreach($tipoMedioVerificacion as $index => $itemTipMedioVerificacion)                          
                               
                                    @if($itemTipMedioVerificacion->codTipoMedioVerificacion == 7) {{-- Otro --}}
                                         <div class="form-check form-switch">
                                           <input class="form-check-input" type="checkbox" wire:model="codTipoMedioVerificacionCheck" role="switch" id="flexSwitchCheckTipoMedioVerificacions" value="{{ $itemTipMedioVerificacion->codTipoMedioVerificacion }}">
                                           <label class="form-check-label campo-glosa" for="flexSwitchCheckTipoMedioVerificacions">{{ $itemTipMedioVerificacion->descripcionTipoMedioVerificacion }}</label>
                                         </div>
                                    
                                         {{-- Si se selecciona se muestra el input descripTipoMedioVerificacionOtro --}}
                                        @if (!empty($tipoMedioVerificacion))
                                            @foreach($codTipoMedioVerificacionCheck as $index => $itemChk)     
                                             @if($itemChk == 7) {{-- Otro --}}           
                                              <input type="text" id="descripTipoMedioVerificacionOtro" wire:model.debounce.250ms="descripTipoMedioVerificacionOtro" wire:loading.attr="disabled" wire:target="firstStep" maxlength="300" class="form-control mt-2" placeholder="Descripción Otro (opcional)">                                                   
                                             @endif
                                            @endforeach                  
                                        @endif                                           
                                    @else
                            ...
                            @error('codTipoMedioVerificacionCheck')
                                <div class="col-12 pe-md-5" id="idcodTipoMedioVerificacionCheckError">
                                    <span class="colorerror">{{ $message }}</span>
                                </div>
                            @enderror
            ...
            <div class="card mt-1" id="actividadesHead">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item ms-1 me-1 ms-md-4 me-md-1" id="actividadId{{$loop->index+1}}">
                            ...
                            <div class="col-11 pe-1 pe-md-2">
                                <div class="card">
                                    <div class="card-header" style="text-align:justify;">
                                        ...
                                        @if($duracionMaxMeses > 0) 
                                           <b><div class="text-success" style="font-size:14px;">(El tiempo máximo de ejecución para su proyecto es de <span class="text-primary">{{ $duracionMaxMeses }} meses</span>, se debe ajustar a ese rango).</div></b>
                                        @endif
                                    </div>
                                    <div class="card-body pt-3">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <input type="checkbox" wire:model.debounce.250ms="inputsActividad.{{$index}}.mesesEjecuActividad" class="btn-check" id="mes{{$index}}7" value="7">
                                                <label class="btn btn-sm btn-outline-primary" for="mes{{$index}}7">Mes 8</label>
                                            </div>
                        ...
                        <div class="row my-3">
                            <div class="col-11 pe-1 pe-md-2" id="iddescripBienesServRRHHActividad{{$index}}" data-tippy-content="Describa: Los bienes, Servicios y Recursos Humanos que necesitará para realizar la actividad: Bienes(cosas o materiales): Objetos que necesitará comprar. Ejemplos: Pintura, cemento, sillas, balones, telas, materiales para talleres etc... Servicios(trabajos que realizará alguien): tareas que se pagan para que una persona o empresa las ejecute. Ejemplos: Arreglo de techumbre, instalación eléctrica, arriendo de equipos de sonido, impresión de afiches etc... Recursos Humanos (RRHH = personas contratadas): Personas que se contratarán para apoyar el proyecto. Ejemplos: maestro constructor, profesor de fútbol, monitor de manualidades, coordinador de actividades etc...">
                                <label>Descripción de los Bienes, Servicios Y/O RRHH necesarios para ejecutar la actividad</label>
                                <textarea wire:model="inputsActividad.{{$index}}.descripBienesServRRHHActividad" wire:loading.attr="disabled" wire:target="secondStep,back" class="form-control mt-1" maxlength="200" rows="7" placeholder="Describa: Los bienes, Servicios y Recursos Humanos que necesitará para realizar la actividad: Bienes(cosas o materiales): Objetos que necesitará comprar. Ejemplos: Pintura, cemento, sillas, balones, telas, materiales para talleres etc... Servicios(trabajos que realizará alguien): tareas que se pagan para que una persona o empresa las ejecute. Ejemplos: Arreglo de techumbre, instalación eléctrica, arriendo de equipos de sonido, impresión de afiches etc... Recursos Humanos (RRHH = personas contratadas): Personas que se contratarán para apoyar el proyecto. Ejemplos: maestro constructor, profesor de fútbol, monitor de manualidades, coordinador de actividades etc... (máximo 200 caracteres)"></textarea>
                            </div>
                ...
                <div class="card-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab">
                            <button wire:click="$set('tabActive', 1)" class="nav-link @if($tabActive == 1) active h6 text-success @endif @if ($errors->has('inputsRecursosHumanos.*')) text-danger @endif shadow" id="nav-home-tab" type="button">
                                Recursos Humanos
                            </button>
                            <button wire:click="$set('tabActive', 2)" class="nav-link @if($tabActive == 2) active h6 text-success @endif @if ($errors->has('inputsGastosGenerales.*')) text-danger @endif shadow" id="nav-profile-tab" type="button">
                                Gastos Generales
                            </button>
                            <button wire:click="$set('tabActive', 3)" class="nav-link @if($tabActive == 3) active h6 text-success @endif @if ($errors->has('inputsEquipamiento.*')) text-danger @endif shadow" id="nav-contact-tab" type="button">
                                Equipamiento
                            </button>
                        </div>
                    </nav>
                    @if($tabActive == 1) 
                        <div class="alert alert-info border border-info mb-2 shadow mt-4" role="alert">
                        <h4 class="alert-heading text-center fw-bold fs-5">Recursos Humanos</h4>
                        <hr>
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                R</span><span class="fs-6"><b>ecursos Humanos (RRHH):</b> son las personas que trabajan en alguna actividad. En un proyecto, se refiere a la personas que se contratarán para realizar una actividad relacionada con el proyecto. Por Ejemplo: maestros, profesores o monitores etc...</span>
                        </p>
                    </div>
                    @endif
                    ...
                    @if($tabActive == 2) 
                         <div class="alert alert-info border border-info mb-2 shadow mt-4" role="alert">
                        <h4 class="alert-heading text-center fw-bold fs-5">Gastos Generales</h4>
                        <hr>
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                G</span><span class="fs-6"><b>astos Generales:</b> Son los gastos de apoyo que se necesitarán para que el proyecto funcione bien, pero que no son una actividad principal. 
                                Ejemplos: Materiales de oficina (lápices, hojas, carpetas etc...), transporte o movilización para llevar materiales, aseo básico o limpieza después de las actividades etc...
                    </span>
                        </p>
                        </div>
                    @endif
                    ...
                    @if($tabActive == 3) 
                        <div class="alert alert-info border border-info mb-2 shadow mt-4" role="alert">
                        <h4 class="alert-heading text-center fw-bold fs-5">Equipamiento</h4>
                        <hr>
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                E</span><span class="fs-6"><b>quipamiento:</b> Son los objetos o herramientas grandes que se necesitarán para realizar las actividades del proyecto. Ejemplos: Mesas, sillas para talleres, 
                                computadores, impresoras, balones, redes o implementos deportivos, herramientas de construcción tales como: martillos, taladros, escaleras etc...
                        </span>
                        </p>
                        </div>
                    @endif
...
<div class="row {{ $currentStep != 4 ? 'displayNone' : '' }} ms-1 pe-3 ms-md-5 pe-md-3" id="step-4">
    <div class="col-12">
            <div class="alert alert-info border border-info mb-2 shadow mt-2" role="alert">
                        <h4 class="alert-heading text-center fw-bold fs-5">Documentos del Proyecto</h4>
                        <hr>
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                R</span><span class="fs-6">evise en el siguiente enlace el check list de documentos necesarios para postular:                            
                                    <a href="https://gorebiobio.cl/wp-content/uploads/2025/09/CHECK-DOCUMENTOS-REQUERIDOS-EN-LA-POSTULACION-PARA-LA-ADMISIBILIDAD-ADMINSTRATIVA.pdf" target="_blank">CHECK-DOCUMENTOS-REQUERIDOS-EN-LA-POSTULACION-PARA-LA-ADMISIBILIDAD-ADMINSTRATIVA.pdf</a>. 
                                    Toda la documentación debe estar unida en un único archivo en formato <b>PDF</b> con un tamaño máximo de <b>30MB</b>. Para unir los documentos puede utilizar herramientas gratuitas como 
                                    por ejemplo: <b>I Love PDF</b> <a href="https://www.ilovepdf.com/es/unir_pdf" target="_blank"> https://www.ilovepdf.com/es/unir_pdf</a>.
    ...
    <div class="col-12 offset-0 col-md-12 mt-md-3 mt-2">
                    ...
                    <div class="col-12 ps-5 pe-5">
                        <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                            <div class="row">
                                <div class="col-12">
                                    <label>
                                        Adjuntar documentación del Proyecto (Formato: PDF, Tamaño Máximo: 30MB)
                                    </label>
...
<!-- Fin Mensaje final de exito -->
 ...
 <div wire:ignore.self class="modal fade" id="modalInfoAgnosExist" data-bs-keyboard="true"> 
        <div class="modal-dialog modal-xl"> 
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title ps-3 campo-glosa" id="modalInfoAgnosExistLabel">
                        Años de Existencia
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="modalBodyAgnosExist"> 
                 ...
                 <div class="col-12 text-center">
                    <div class="alert alert-info border border-info  shadow me-2" role="alert">                        
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;"> 
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                E</span><span class="fs-6">n el siguiente <b>Certificado de Vigencia</b> la <b>fecha de inscripción</b> se realizó el <b>22-10-2014</b> y si tomamos como <b>fecha actual de referencia</b> el 
                                <b>02-09-2025</b> y realizamos el cálculo obtenemos que los <b>años de existencia legal</b> son igual a <b>10</b> (no se deben considerar meses ni días parciales).</span>                             
                        </p>
                    </div>
                   </div>
                 </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 mt-1 mb-2 text-center">
                            <img  class="img-fluid" src="images/certificado_vigencia.png" width="650rem" height="350rem">
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light p-3 p-md-4"></div>
            </div>
        </div>
  </div> 


  <div wire:ignore.self class="modal fade" id="modalInfoFecVencDirectiva" data-bs-keyboard="true"> 
        <div class="modal-dialog modal-xl"> 
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title ps-3 campo-glosa" id="modalInfoFecVencDirectivaLabel">
                        Fecha Vencimiento Directiva
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="modalBodyFecVencDirectiva"> 
                ...
                <div class="col-12 text-center">
                    <div class="alert alert-info border border-info  shadow me-2" role="alert">                        
                        <p class="fs-5 fst-italic px-4" style="text-align:justify;text-indent: 30px;">
                            <span class="fw-bold fs-3 text-white"
                                style="background-color:#17a2b8;border:2px solid;border-radius:5px;padding-left:4px;padding-right:8px;font-family:Nunito-ExtraLightItalic;">
                                E</span><span class="fs-6">n el siguiente <b>Certificado de Directorio</b> la <b>última elección de directiva</b> se realizó el <b>09-11-2024</b> y la <b>duración de directiva</b> es de <b>3 años</b>. Por lo tanto,  
                                si sumamos la <b>duración de la directiva</b> a la fecha de la <b>última elección de directiva</b> obtenemos que la <b>fecha de vencimiento</b> corresponde al <b>09-11-2027</b>.</span>                                
                        </p>
                    </div>
                    </div>
                    </div>
                    <div class="row mt-3 mb-4">
                        <div class="col-12 mt-1 mb-2 text-center">
                            <img class="img-fluid" src="images/certificado_directorio.png" width="650rem" height="480rem">
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light p-3 p-md-4"></div>
...
<script>
  var modalInfoAgnosExist = null;
  var modalInfoFecVencDirectiva = null;

  function showmodalInfoAgnosExist() {
    try {
      modalInfoAgnosExist.show();
    } catch (err) {
      modalInfoAgnosExist = new bootstrap.Modal((document.getElementById('modalInfoAgnosExist')));
      modalInfoAgnosExist.show();    
    }
  }

  function closemodalInfoAgnosExist() {
    try {
      modalInfoAgnosExist.hide();
    } catch (err) {    
      modalInfoAgnosExist = new bootstrap.Modal((document.getElementById('modalInfoAgnosExist')));
      modalInfoAgnosExist.hide();
    }
 ...
 function showmodalInfoFecVencDirectiva() {
    try {
      modalInfoFecVencDirectiva.show();
    } catch (err) {
      modalInfoFecVencDirectiva = new bootstrap.Modal((document.getElementById('modalInfoFecVencDirectiva')));
      modalInfoFecVencDirectiva.show();    
    }
  }

  function closemodalInfoFecVencDirectiva() {
    try {
      modalInfoFecVencDirectiva.hide();
    } catch (err) {    
      modalInfoFecVencDirectiva = new bootstrap.Modal((document.getElementById('modalInfoFecVencDirectiva')));
      modalInfoFecVencDirectiva.hide();
    }
    ...
    window.addEventListener('swal:confirmEnvioPostu', event => {
        (async () => {
            ...
            const {
                ...
                input: 'checkbox',
                inputValue: 0,
               inputPlaceholder: '<div style="text-align:justify;margin-left:0.8rem;font-weight: 400;font-style: italic;"> He revisado y me he cerciorado que tanto el documento adjunto como la información están correctamente ingresados.</div>',
